...
var field: Field?
var player2: PlayerClass = PlayerFactory.create(PlayerEnum.Human, figure: Figure.X)!
var player1: PlayerClass = PlayerFactory.create(PlayerEnum.ComputerMinMax, figure: Figure.O)!
